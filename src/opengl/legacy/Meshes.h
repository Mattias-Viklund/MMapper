...
// Textured mesh with color modulated by uniform
template<typename VertexType_>
class NODISCARD WaterMesh final : public SimpleMesh<VertexType_, WaterTexturedShader>
{
public:
    using Base = SimpleMesh<VertexType_, WaterTexturedShader>;
    using Base::Base;
...
private:
    ...
    void update_shader() override { Base::m_program.updateTime(); }

    //void SimpleMesh::virt_render()
    //{
    //    int a = 0;
    //    int b = 2;
    //}
